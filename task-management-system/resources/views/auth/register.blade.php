    ...
    <div class="flex flex-col justify-between min-h-screen px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
        ...
        <div class="w-full max-w-md mx-auto mt-5">
            <div class="text-center sm:text-left">
                <p class="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight"> Welcome</p>
                <p class="py-2 text-sm sm:text-base text-gray-600 dark:text-gray-400">Hey! welcome back to phsar khmer
                </p>
            </div>
        </div>

        @include('auth.partials.tab', ['isSupplier' => false])
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            {{-- <div class="mt-4">
                <x-input-label for="request_role" :value="__('Request Role')" />
                <select class="select select-lg w-full block mt-1" name="request_role" required style="font-size: 16px">
            ...
            <a href="{{ route('google.login', ['request_role' => App\Enums\UserRole::SUPPLIER]) }}"
