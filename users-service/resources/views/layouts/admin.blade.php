...
@php
    $sidebarLinks = [
        ...
        [
            'label' => 'LineItem',
            'route' => 'admin.line-items.index',
            'icon' => 'heroicon-o-inbox-stack',
            'header' => 'admin.line-items',
        ],
        [
            'label' => 'Users',
        ...
        [
            'label' => 'OptionTypes',
            'route' => 'admin.option-types.index',
            'icon' => 'heroicon-o-rectangle-group',
            'header' => 'admin.option-types',
        ],
        [
            'label' => 'OptionValues',
            'route' => 'admin.option-values.index',
            'icon' => 'heroicon-o-rectangle-stack',
            'header' => 'admin.option-values',
        ],
        [
            'label' => 'Roles',
        ...
        [
            'label' => 'Sections',
            'route' => 'admin.home-section.index',
            'icon' => 'heroicon-o-exclamation-circle',
            'header' => 'admin.home-section',
        ],
        [
            'label' => 'Reports Blueprints',
            'route' => 'admin.report-blueprints.index',
            'icon' => 'heroicon-o-book-open',
            'header' => 'admin.report-blueprints',
        ],
        [
            'label' => 'Reports',
